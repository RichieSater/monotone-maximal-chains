...
repository}.  Release \texttt{v1.1.0} contains the standalone verifier and
...
From 8 to 29 August 2026, the author used the
\href{https://developers.openai.com/codex/cli/}{OpenAI Codex CLI}, versions
0.147.0 and 0.150.1 with model GPT-5.6-sol, through a locally installed
command-line client for mathematical exploration, literature searches, GAP
and regression-test development, proof auditing, and editorial revision; the
theorem is proved by the mathematical argument presented here, the reported
computations have the stated finite scope, and the author takes responsibility
for the manuscript.
...
\bibitem{Repository}
R. Sater,
\emph{A negative answer to a question on monotone maximal chains in finite
groups}, version 1.1.0 preprint and verification archive (2026),
\href{https://doi.org/10.5281/zenodo.21878837}{doi:10.5281/zenodo.21878837}.
